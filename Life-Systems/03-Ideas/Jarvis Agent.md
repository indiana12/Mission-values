...
[[Life-Systems/03-Ideas/Ideas|← Ideas]]
...
- Business, tech, or trend notes stored elsewhere in the vault and tagged `#market`, `#tech`, or `#strategy`.
...
5. Capture follow-up tasks in **Notes to Future Me** and add reminders in your task system if needed.

## Prompt Starters
- “Jarvis, generate four fresh concepts using yesterday’s `Ideas - Capture Log` entries tagged `#spark`.”
- “Jarvis, pressure-test the note `Idea - Community Skill Exchange` for feasibility and offer the quickest validation experiment.”
...
## Maintenance
- Refresh prompts monthly with what worked.
- Archive stale ideas into a “Dormant” section to keep Jarvis focused on current opportunities.
